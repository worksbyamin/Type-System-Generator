    ...
    <div className="bg-[#1c1c1f] rounded-xl border border-white/5 overflow-hidden transition-all">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {hasVariableFont && (
            <span className="text-[10px] bg-white/10 text-neutral-200 px-1.5 py-0.2 rounded font-mono">
              Active
            </span>
          )}
        </div>
        ...
        <div className="p-4 pt-1 flex flex-col gap-4 border-t border-white/5 bg-[#17171a]/50">
          {hasVariableFont ? (
            ...
            <div className="flex flex-col gap-2.5 text-xs text-neutral-400">
              <p>
                The selected font (<strong className="text-white">{config.fontHeading}</strong>) does not declare custom variable axes.
              </p>
              <div className="p-2.5 bg-[#202024] rounded-lg border border-white/5 flex flex-col gap-1.5">
                  ...
                  {['Inter', 'Roboto Flex', 'Vazirmatn', 'Plus Jakarta Sans', 'DM Sans'].map(
                    (vf) => (
                      <button
                        ...
                        className="px-2 py-1 bg-white/10 hover:bg-white text-neutral-300 hover:text-black rounded text-[11px] transition-colors"
                      >
                        {vf}
                      </button>
                    )
